-- Tạo bảng BUMON trước (vì các bảng khác tham chiếu đến nó)
CREATE TABLE BUMON(
...
-- Tạo bảng ES_YDENPYOD với khóa chính composite
CREATE TABLE ES_YDENPYOD (
    ...
    -- Định nghĩa khóa chính composite
    CONSTRAINT PK_ES_YDENPYOD PRIMARY KEY (DENPYONO, GYONO),
    
    -- Định nghĩa khóa ngoại
    CONSTRAINT fk_ES_YDENPYOD 
